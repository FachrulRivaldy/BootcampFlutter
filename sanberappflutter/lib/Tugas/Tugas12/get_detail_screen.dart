// ignore_for_file: unnecessary_brace_in_string_interps, avoid_print, avoid_unnecessary_containers, library_private_types_in_public_api, no_logic_in_create_state, must_be_immutable
...
class _GetDataDetailScreenState extends State<GetDataDetailScreen> {
  ...
  @override
  void initState() {
    var url = 'http://reqres.in/api/users/${value.toString()}';
    _getRefreshData(url);
